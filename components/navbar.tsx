  ...
  return (
    <div className="inline ">
      <div className="sticky border rounded-full mt-4 container w-11/12 mx-auto top-3 left-0 flex h-[60px] justify-between items-center z-50 backdrop-blur-sm">
        ...
        <div
          className={`md:flex flex-grow justify-center gap-5 hidden ${
        ...
        <a
          href="https://drive.google.com/uc?export=download&id=14mLF3eVDI5EroRx7WLmYhrqowmur7gWa"
          download="HackTheTank 2.0 Brochure"
        >
